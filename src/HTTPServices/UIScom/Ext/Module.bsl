...
Функция IncomingCall_IN(Запрос) 
	...
	Иначе // --------------------------------------------------------   
		...
		Канал = ?(стрЗвонка.Канал = "", CentrifugoСервер.ПолучитьКаналПоНомеру( стрЗвонка.Номер ), стрЗвонка.Канал);  
		стрЗвонка.Добавить("Канал", Канал);
		
		Если стрЗвонка.Входящий И ОтправлятьСразуВCentrifugo Тогда
