...
//
 Функция ПолучитьСписокЗамен()
	 ...
	 СписокЗамен.Добавить("Исходящий", "Outcoming");СписокЗамен.Добавить("Исходящего","out");
	 СписокЗамен.Добавить("Потерянный", "Lost");    СписокЗамен.Добавить("Потерянного", "Lost");
	 
	 СписокЗамен.Добавить("Абонент", "Client");     СписокЗамен.Добавить("Сотрудник", "Operator"); 
