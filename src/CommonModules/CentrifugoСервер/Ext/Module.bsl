...
//
  Функция ПолучитьСписокЗамен()
	 ...
	 СписокЗамен.Добавить("время", "time");  	  СписокЗамен.Добавить("времени", "time");// сценарий (по умолчанию)
	 СписокЗамен.Добавить("рабочее", "working");  СписокЗамен.Добавить("рабочего", "working");	
	 СписокЗамен.Добавить("нерабочее", "non-working"); 
	 СписокЗамен.Добавить("Сценарий для", "Scenario for"); // 05.09.2022 Сценарий для рабочего времени
