...
//
 Функция ПолучитьСписокЗамен()
	 ...
	 СписокЗамен.Добавить("рабочее время", "working time");    // ВСЕ названия сценариев
	 
	 СписокЗамен.Добавить("Завершение звонка", "Finish call"); 
	 СписокЗамен.Добавить("Потерянный звонок", "Lost call");
	 СписокЗамен.Добавить("Исходящий звонок", "Out call");
	 СписокЗамен.Добавить("Входящий звонок", "In call");
	 
	 СписокЗамен.Добавить( "Сотрудник разорвал соединение", "Operator aborted connection");
	 СписокЗамен.Добавить("Абонент не отвечает", "Client no answer");
